// SOURCE: local_49e5de43-a337-4fd2-9b98-4dd13c5e43c9 / artifact: daily-status
// TODO: 해당 세션의 .claude/tasks/ JSON에서 아티팩트 코드를 붙여넣으세요

export default function DailyStatus() {
  return (
    <PlaceholderMessage name="Daily Status" sessionId="local_49e5de43-a337-4fd2-9b98-4dd13c5e43c9" artifactId="daily-status" />
  )
}

function PlaceholderMessage({ name, sessionId, artifactId }) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: 16, color: '#8888aa' }}>
      <div style={{ fontSize: 48 }}>📋</div>
      <div style={{ fontSize: 18, color: '#e8e8f0' }}>{name}</div>
